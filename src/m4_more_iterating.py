...
def run_test_count_items_bigger_than():
    ...
    # My Test 1:
    sequence = [97, -1222, -56, 23124, 0.3433, 40]
    threshold = -121
    expected = 5
    actual = count_items_bigger_than(sequence, threshold)
    print()
    print('My Test 1 expected:', expected)
    print('       actual:  ', actual)

    # My Test 2:
    sequence = [2389123, -2412214, 1222, 1230.12314, 0, 25858]
    threshold = 247584
    expected = 1
    actual = count_items_bigger_than(sequence, threshold)
    print()
    print('My Test 2 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_count_positive_sines():
    ...
    # My Test 1:
    expected = 2
    actual = count_positive_sines([22, 5, 17, 88, 9999])
    print()
    print('My Test 1 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # My Test 1:
    expected = 711313.3
    actual = sum_first_n([43, 34354, 73653.3, 352454, 246247, 4562], 7)
    print()
    print('My Test 1 expected:', expected)
    print('       actual:  ', actual)
    ...
    # My Test 2:
    expected = 31561
    actual = sum_first_n([-574, 32135, 24523524, 3131, -21434], 2)
    print()
    print('My Test 2 expected:', expected)
    print('       actual:  ', actual)
