...
def run_test_count_negatives():
    ...
    # MyTest 1:
    expected = 3
    actual = count_negatives([-12, 347329754, -12323.43523, -0.4752874])
    print()
    ...
    # MyTest 2:
    expected = 2
    actual = count_negatives([32.5, -47, 18.12314, 23, -19])
    print()
...
def run_test_count_short_ones():
    ...
    # My Test 1:
    expected = 2
    seq = [[34, 65, 877, 778, 7987, 5363, 3653], [2, 43, 65, 666], [2323], []]
    actual = count_short_ones(seq)
    print()
    print('My Test 1 expected:', expected)
    print('       actual:  ', actual)
    ...
    # My Test 2:
    expected = 4
    seq = [[1, 1], [16, 535, 8], [21, 45], [1, 12], [3, 4]]
    actual = count_short_ones(seq)
    print()
    print('My Test 2 expected:', expected)
    print('       actual:  ', actual)
